...
pun2.addEventListener('click', () => {
    const objeto = {
        title: 'Soy el titulo',
        body: 'Soy un cuerpo muy extenso'
    }
    solicitudPost(objeto);
})

// Punto 3
// No me funciono el link de la consigna, por eso traigo una imagen de Api Pokemon
...
function imagenPokemon(pokemon){
    ...
    texto.textContent = "No me funciono link de la consigna, por eso realizo actividad con pokemon";
